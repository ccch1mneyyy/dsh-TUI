...
const dict = {
  ...
  'cmd-desc-color': { zh: '设置输入边框颜色' },
  'color-switched': { zh: '边框颜色已切换为：{{name}}', en: 'Border color switched to: {{name}}' },
  'color-reset': { zh: '边框颜色已恢复默认', en: 'Border color reset to default' },
  'color-unknown': { zh: '未知颜色：{{name}}。可用：blue, green, red, yellow, purple, orange, pink, cyan', en: 'Unknown color: {{name}}. Available: blue, green, red, yellow, purple, orange, pink, cyan' },
