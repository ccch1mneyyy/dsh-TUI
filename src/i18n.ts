...
const dict = {
  ...
  'home-hint-list': { zh: '**Enter** 打开 · Tab 切换栏位 · Ctrl+N 新建 · Esc 进入会话 · Ctrl+L 刷新', en: '**Enter** open · Tab switch pane · Ctrl+N new · Esc enter the session · Ctrl+L refresh' },
  ...
  'home-menu-open': { zh: '在会话列表中打开', en: 'Show its sessions' },
  'home-menu-new': { zh: '在此新建会话', en: 'New session here' },
  'home-menu-set-current': { zh: '设为当前工作区', en: 'Make it the current workspace' },
  ...
  'supervisor-hint-list': { zh: '**Enter** 进入 · Tab 切换栏位 · Ctrl+N 新建 · Ctrl+X 停止 · Esc 返回会话', en: '**Enter** enter · Tab switch pane · Ctrl+N new · Ctrl+X stop · Esc back to the session' },
