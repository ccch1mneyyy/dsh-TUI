...
const dict = {
  ...
  'working-activity-narrate-instruction': {
  ...
  'working-activity-waiting': { zh: '等待模型响应', en: 'Waiting for model' },
  'working-activity-thinking': { zh: '思考中', en: 'Thinking' },
  'working-activity-running-tool': { zh: '运行工具', en: 'Running tool' },
  'working-activity-total': { zh: '总{{duration}}', en: 'total {{duration}}' },
  'working-activity-tool-count-one': { zh: '{{count}} 工具', en: '{{count}} tool' },
  'working-activity-tool-count-many': { zh: '{{count}} 工具', en: '{{count}} tools' },
  'working-activity-done': {
    zh: '搞定 ✓ · {{tools}} · 想{{thinking}} 干{{tooling}}',
    en: 'Finished · {{tools}} · thought {{thinking}} worked {{tooling}}',
  },
