...
const dict = {
  ...
  'subagent-title': { zh: '子代理', en: 'Subagents' },
  'subagent-count': { zh: '{{n}} 个子代理', en: '{{n}} subagents' },
  'subagent-list-subtitle': { zh: '选择一个子代理查看完整会话记录', en: 'Select a subagent to inspect its full transcript' },
  'subagent-list-loading': { zh: '正在读取子代理…', en: 'Loading subagents…' },
  'subagent-list-failed': { zh: '无法读取子代理 · {{err}}', en: 'Could not load subagents · {{err}}' },
  'subagent-list-hint': { zh: '↑/↓ 选择 · **Enter** 查看 · Esc 返回', en: '↑/↓ select · **Enter** inspect · Esc back' },
  'subagent-list-hint-short': { zh: '**Esc** 返回', en: '**Esc** back' },
  'subagent-detail-hint': { zh: '↑/↓ 滚动 · ctrl+o 展开 · **Esc** 返回列表', en: '↑/↓ scroll · ctrl+o expand · **Esc** back to list' },
  'subagent-detail-hint-short': { zh: '**Esc** 返回列表', en: '**Esc** back to list' },
  'subagent-read-only': { zh: '只读', en: 'read-only' },
  'subagent-session-loading': { zh: '正在读取会话记录…', en: 'Loading transcript…' },
  'subagent-session-empty': { zh: '这个子代理还没有可显示的会话记录', en: 'This subagent has no transcript yet' },
  'subagent-session-unavailable': { zh: '会话存储不可用，无法读取这个子代理', en: 'Session storage is unavailable for this subagent' },
  'subagent-session-failed': { zh: '无法读取子代理会话 · {{err}}', en: 'Could not load the subagent transcript · {{err}}' },
  'subagent-running-short': { zh: '运行中', en: 'running' },
  'subagent-archived-short': { zh: '已归档', en: 'inactive' },
  'subagent-has-children': { zh: '含子代理', en: 'has children' },
  'subagent-diagnostic-corrupt': { zh: '记录损坏', en: 'corrupt record' },
  'subagent-diagnostic-unsupported': { zh: '格式不受支持', en: 'unsupported format' },
  'subagent-diagnostic-unavailable': { zh: '暂时不可用', en: 'temporarily unavailable' },
  'subagent-diagnostic-hint': { zh: '此记录无法打开，将在下次进入时重试', en: 'This record cannot be opened and will be retried next time' },
