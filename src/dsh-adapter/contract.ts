 ...
 * current primary (0.1.2-alpha.3) plus older lines kept in backward
...
export const UPSTREAM_VALIDATED_VERSION = '0.1.2-alpha.3'

/**
 * Every upstream prerelease line the adapter has been validated against,
 * oldest first.
 *
 * 0.1.2-alpha.3 = primary; 0.1.1-rc.2 and rc.1 are compatibility lines
