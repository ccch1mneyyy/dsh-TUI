 ...
 * dsh-cc call primitives: a single-turn, TOOL-LESS LLM call replaying the
 ...
 */
export function wrapSideQuestion(question) {
...
export async function runSideQuestion(params) {
    ...
    const answer = assembler.blocks()
        ...
        .trim();
    if (answer === '')
        return { answer: null, error: 'No response received' };
    return { answer };
}
