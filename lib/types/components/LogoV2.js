...
export function LogoV2({ model, effort, cwd, skipIntro = false, }) {
    ...
    return (_jsxs(Box, { ref: ref, flexDirection: "column", marginTop: 1, children: [_jsxs(Box, { flexDirection: "row", gap: 2, width: "100%", alignItems: "center", children: [showWhale && _jsx(WhaleArt, { frameIndex: frameIndex, width: FULL_WHALE_WIDTH }), _jsxs(Box, { flexDirection: "column", flexShrink: 1, children: [_jsxs(Text, { wrap: "truncate-end", children: [sweep('✦ dsh-cc', t, wordmarkRGB, wordmarkShimmerRGB, 100), _jsx(Text, { dimColor: true, children: '  v' + VERSION })] }), bigDeepSeek.map((row, index) => (_jsx(Text, { wrap: "truncate-end", children: row }, `ds-${index}`))), bigHarness.map((row, index) => (_jsx(Text, { wrap: "truncate-end", children: row }, `h-${index}`))), _jsxs(Text, { wrap: "truncate-end", children: [model, effort !== undefined && _jsx(Text, { dimColor: true, children: ' · ' + capitalize(effort) + ' effort' })] }), _jsx(Text, { dimColor: true, wrap: "truncate-end", children: cwd }), _jsxs(Text, { wrap: "truncate-end", children: [_jsx(Text, { dimColor: true, children: "Tip: " }), "/model", _jsx(Text, { dimColor: true, children: " \u5207\u6362\u6A21\u578B \u00B7 " }), "/help", _jsx(Text, { dimColor: true, children: " \u67E5\u770B\u547D\u4EE4 \u00B7 " }), "Tab", _jsx(Text, { dimColor: true, children: " \u81EA\u52A8\u8865\u5168" })] })] })] }), _jsx(Box, { marginTop: 1, paddingLeft: 2, children: _jsx(Text, { children: sweep('探索未至之境！', t, taglineRGB, FLASH, 100) }) })] }));
}
