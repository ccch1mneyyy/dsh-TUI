...
import { setActiveThemeName } from '../../theme.js';
...
export function ThemeProvider({ children, theme, }) {
    ...
    const [detected, setDetected] = useState(forced ?? null);
    ...
    if (active === null)
        return null;
    return _jsx(ThemeContext.Provider, { value: active, children: children });
}
