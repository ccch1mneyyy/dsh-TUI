...
export function ActivityLine({ activity, activityFrames, warnPct, warnDanger, suffix, }) {
    ...
    const color = activity.phase === 'done'
        ? 'success'
        : activity.phase === 'tool'
            ? 'claude'
    ...
    return (_jsxs(Text, { wrap: "truncate", children: [activity.phase !== 'done' && (_jsxs(Text, { color: color, children: [frame, " "] })), warnPct !== undefined && warnPct >= 80 && (_jsxs(Text, { color: warnDanger ? 'error' : 'warning', children: ["\u26A0 \u4E0A\u4E0B\u6587", warnPct, "% \u00B7", ' '] })), activity.phase === 'done' ? (_jsx(Text, { color: color, children: activity.line })) : (_jsx(Text, { children: sweep(activity.line, time, baseRGB, FLASH) })), suffix !== undefined && _jsx(Text, { dimColor: true, children: suffix })] }));
}
//# sourceMappingURL=ActivityLine.js.map