...
import { formatClock, formatDuration, truncateWidth, } from '../dsh-adapter/trace.js';
...
export function TraceView({ entries, cursor, filter, }) {
    ...
    return (_jsxs(Pane, { color: "permission", children: [_jsxs(Box, { flexDirection: "column", children: [_jsxs(Box, { marginBottom: 1, children: [_jsx(Text, { color: "remember", bold: true, children: t('trace-title') }), _jsx(Text, { dimColor: true, children: t('trace-subtitle', {
                    ...
                    }))] }), _jsx(Text, { dimColor: true, italic: true, children: _jsxs(Byline, { children: [_jsx(KeyboardShortcutHint, { shortcut: "\u2191/\u2193 PgUp/PgDn g/G", action: "scroll", bold: true }), _jsx(KeyboardShortcutHint, { shortcut: "f", action: "filter" }), _jsx(KeyboardShortcutHint, { shortcut: "Esc/q", action: "close" })] }) })] }));
}
