 ...
 * ~/.dsh-cc/themes (sorted by file name). A user theme named `auto` is
 ...
 * every user theme found in ~/.dsh-cc/themes — each row shows the display
 ...
 * ~/.dsh-cc/theme.json and hot swaps), Esc cancels.
 */
