...
import { extendTrace, filterTraceEntries, TRACE_FILTERS, } from '../trace.js';
    ...
    const runCommand = (name, rawInput = '') => {
        switch (name) {
            ...
            case 'theme': {
                ...
                // Selection persists to ~/.dsh-tui/theme.json and hot swaps via the
