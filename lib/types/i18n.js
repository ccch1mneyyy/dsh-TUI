...
const dict = {
    ...
    'update-unavailable': { zh: '当前运行方式不支持自动更新，请在终端执行 dsh plugin --profile cc-tui update dsh-cc-tui', en: 'Automatic update is unavailable in this launch mode. Run dsh plugin --profile cc-tui update dsh-cc-tui in a terminal.' },
