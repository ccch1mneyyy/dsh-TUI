...
import { blitRegion, extractHyperlinkFromStyles, filterOutHyperlinkStyles, markNoSelectRegion, OSC8_PREFIX, resetScreen, setCellAt, shiftRows, } from './screen.js';
...
export class CharCache {
    ...
    set(line, characters) {
        if (line.length > MAX_CACHEABLE_LINE)
            return;
        if (this.map.size >= CHAR_CACHE_MAX_ENTRIES ||
