...
- [Configuration (`profile/cordis.patch.yml`)](en/configuration.md)
- [Agent Presets (Four Official Agent Modes)](en/agent-presets.md)
- [Custom Themes](en/custom-themes.md)
- [MCP](en/mcp.md)
